			  	...
			  	<form action="#" method="post">
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
				  				<?php echo '<input type="text" name="location" value="'.$f_loca.'" placeholder="e.g: Nikunja 2, Patiala">'; ?>
				  			</div>
				  		</div>
					<div class="itemrow">
				  			<div style="width: 20%; float: left;">
							...
							<div style="width: 80%; float: left;">
							  ...
							  <option value="LPU University">LPU University</option>
							  <option value="Telangana Univesity">Telangana Univesity</option>
                              <option value="Pune Univesity">Pune Univesity</option>
                              <option value="Mumbai Univesity">Mumbai Univesity</option>
							</select>
							</div>
						</div>
					<div class="itemrow">
				  			...
				  			<div style="width: 20%; float: left;">
				  				<p><?php echo '<input name="deadline" type="text" id="datepicker" placeholder="e.g: 30/07/2021" value="'.$f_dead.'">'; ?></p>
				  			</div>
				  		</div>
